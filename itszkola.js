...
switch(nazwaKursu){
    ...
    arr=[['któryzponiżejwymienionychalgorytmównajszybciejzrealizujezadanieporządkowaniazbioru','algorytmquicksort'],['ileporównańnależydokonaćabywzbiorzen–elementowymznaleźćwartośćminimaxstosującalgorytmdzielizwyciężaj','3n/2-2'],['jakiezadanierealizujeprzedstawionyponiżejzapomocąlistykrokówalgorytm?krok1dlaj=1,2,..,n-1wykonajkrok1…krok4,anastępniezakończalgorytmkrok2pmin-jkrok3dlai=j-1,j+2,…,njeżelid[i]d[pmin],topmin-ikrok4d[j]-d[pmin]','sortowanieprzezwybór'],['jakiejzłożonościobliczeniowejjestalgorytmsortowaniamargesort','logarytmicznej'],['stosującalgorytmwyszukiwaniaprzezpołowieniedlazbioruuporządkowanegoowielkościn=100000,ilenależymaksymalniewykonaćporównańabysprawdzićczyliczbalznajdujesięwzbiorze.','17'],['wskażzdanieprawdziwe.metodaprogramistycznadzielizwyciężajwykorzystywanawcelusprawdzeniaczyzadanawartośćznajdujesięwzbiorze,realizowanajestdlazbiorów…','uporządkowanych'],['ilenależyrozegraćdodatkowychmeczywturniejutenisowymabywyłonićdrugiegonajlepszegograczaturniejuwiedząc,żeliczbauczestnikówjestrównan=8','2'],['ileoperacjiporównanianależywykonaćabydlanieuporządkowanegozbiorudwudziestoelementowego,wyszukaćwartośćnajmniejszą?','19'],['któryzponiżejwymienionychalgorytmównajszybciejwyświetliwynikoperacjiwyszukiwaniawzbiorzenieuporządkowanymzadanejprzezużytkownikawartości','algorytmwyszukiwanialiniowegozwartownikiem'],]
        break;
    case "Programowanie współbieżne w informatyce i nie tylko"://10/10
    arr=[['kiedyprogramwspółbieżnyjestpoprawny?','kiedyspełniazarównowymogiwłasnościbezpieczeństwajakiżywotności'],['zponiższychpodpowiedziwybierzto,któreopisujepojęcieproceswujęciuprogramowaniawspółbieżnego.','toobiektydynamicznewykonująceciąginstrukcji'],['naczympolegaproblemzakleszczeniawprogramowaniuwspółbieżnym','wsystemienicsięniedzieje,aprocesyoczekująnazdarzeniektórenigdyniezajdzie'],['conazywamywykonaniemprogramówasynchronicznie?','wykonywanieprogramówprzezprocesyniezależnieodsiebie'],['którezwymienionychponiżejzdańsąwłasnościamibezpieczeństwaprogramówwspółbieżnych?','programmusibyćbezpiecznydlawszystkichmożliwychprzeplotów'],['którezponiższychzdańjestprawdziwe?','dwaróżneprocesymogąwykonywaćtensamprogram'],['jeżelidwaprocesywykonująwspółbieżnietensamprogramzwiększaniapięciokrotnegowartościxojeden,gdziewartośćpoczątkowaxjestrówna0.jakąwartośćmożeprzyjąćxpozakończeniuobydwuprocesów.wskażprawidłowąodpowiedź.','xzawszebędziemniejszebądźrówne10'],['wskażcechęprogramowaniawspółbieżnego.','bardzodobraelastycznośćistrukturaprogramu'],['którezprzedstawionychponiżejsposobówwykonaniaprogramówwspółbieżnychnależydokategoriiwykonanianierównoległego?','systemówprzeplocie'],['conazywamyprogramemwspółbieżnym?','jesttoprogramw,którymwieleczynnościmożeodbywaćsięjednocześnie'],]
        break;
    case "Proste rachunki wykonywane za pomocą komputera"://10/10
    arr=[['dlaktórejparyliczb,15jestnajwiększymwspólnymdzielnikiem?','105,135'],['którezponiższychwyrażeńniedajepoprawnejwartościpotęgix27?uwaga.znak^oznaczapotęgowanie.','(((x^2)^2)^2)^2+((x^2)^2)^2x^3'],['jakąreprezentacjębinarnąmasumadwóchliczbbinarnych:111111+111111','1111110'],['jakajestreprezentacjaliczby2009wsystemieopodstawie8?','3731'],['schemathornerasłużydo:','szybkiegoobliczaniawartościwielomianu'],['któryzapisjestpoprawnymschematemhorneradlawielomianu:x5-x3-x2+1uwaga.wodpowiedziach,znak^oznaczapotęgowanie.','((((x)x-1)x-1)x)x+1'],['jakąwartośćdziesiętnąmaliczbabinarnazłożonazsześciujedynek?uwaga:symbol^oznaczapotęgowanie.','2^6-1'],['jakisystemliczbowyniejeststosowanywkomputerach?','kopcowy'],['jakąinstrukcjęnależywstawićwmiejscewykropkowane,byotrzymanywtensposóbprogramgenerowałkolejne(odnajmniejznaczącej)cyfrywrozwinięciuliczbyxprzypodstawie3?intmain(){intxcout"podajwartoscdlax:"cinxwhile(x!=0){cout.......x=x/3}}','x%3'],['jakibędziewynikwykonanianastępującegoprogramudladanych:49i14?intmain(){inta,bcout"podajwartoscdlaa:"cinacout"podajwartoscdlab:"cinbwhile((a!=0)&&(b!=0)){if(ab){a=a-b}else{b=b-a}}}','7'],]
        break;
    case "Przegląd podstawowych algorytmów"://10/10
    arr=[['jakajestostatniacyfranwd(11914,17710)wzapisiedziesiętnym?','2'],['wmieścieznajdujesięskrzyżowaniaijednokierunkowedrogi.każdadrogałączydwaskrzyżowaniaiznamyczasjejprzejazdu.chcemywyznaczyćminimalnyczasprzejazdupomiędzydwomazadanymiskrzyżowaniami.dorozwiązaniategoproblemumożemyużyćalgorytmu:','dijkstry'],['chcemywyznaczyćliczbęspójnychskładowychwgrafienieskierowanymo3mlnkrawędzii1mlnwierzchołków.wrozsądnymczasietozadanierozwiąże(zakładamy,żeniemadodatkowegoograniczeniapamięcinawielkośćstosu):','algorytmdfsdlagrafuwpostacilistsąsiedztwa'],['chceszposortowaćtablicęmilionaliczbnaturalnychzprzedziału[1,1000].którametodajestnajlepszadotegocelu?','sortowanieprzezzliczanie'],['któryelementtablicy[7,1,4,5,2,8,11]zostaniewybranywtrzecimkrokusortowniaprzezwybór?','4'],['uruchomiliśmyalgorytmbellmana-fordadlagrafuskierowanegoo10wierzchołkach,abywyznaczyćnajkrótsześcieżkizwierzchołkanr1.dziesiątaiteracjawalgorytmiespowodowałaudanąrelaksację.oznaczato,że:','wgrafieistniejecykloujemnejwadze'],['chcemywydaćjakąśkwotęzapomocąminimalnejliczbymonetzpewnegozestawu.stosujemyalgorytmzachłanny:wybieramyzawszenajpierwnajwiększąmonetę.którezponiższychzdańsąprawdziwe?','czasamiwydamykwotęminimalnąliczbąmonet.'],['sortujemyprzezscalanietablicęzłożonąz16elementów.którezponiższychliczbmogąbyćdługościamiscalanychkawałkówtablicy?','2'],['czegonależyużyćprzyszukaniunajdłuższegowspólnegopodciągudwóchciągów?','tablicy'],['chcemyjednokrotniesprawdzić,czywtablicytjestpewienelementx.którerozwiązanieuważaszzanajlepsze?','liniowoprzejrzećwszystkieelementywt,sprawdzającczysąrównex'],['ilewystąpieńsłowaabbaznajdziewtekścieabbbaabababbbabbabbabbababbaalgorytmknutha-morrisa-pratta?','4'],['programowaniedynamicznejest:','strategiąprojektowaniaalgorytmów'],['ilemniejwięcejwykonamykrokówwyszukującbinarnieelementuwtablicyo1000000elementów?','20'],['złożonośćoptymalnegoalgorytmuszukaniawypukłejotoczkizbiorupunktównapłaszczyźniejest:','liniowo-logarytmiczna'],['którezponiższychsąpoprawnymisłowami(wsensieinformatycznym)?','słoń'],['"danajestkwotakzłorazzbiórnominałów.każdegonominałumamynieskończeniewielemonet.ileminimalniemonetpotrzebadowydaniakwotyk?przykładowokwotę17zł,mającnominały20zł,10zł,5złi1zł,możemywydaćczteremamonetami,gdyż17=10+5+1+1."powyższyproblemmożnarozwiązaćkorzystającz:','programowaniadynamicznego'],['którezpodanychsłówjestnajdłuższymprefikso-sufiksemsłowaabaababaabaab?','abaab'],['abywgrafienieskierowanymistniałcykleulerakoniecznesąponiższewarunki:','każdywierzchołekmaparzystystopień'],['copomagawobliczaniupólwielokątównapłaszczyźnie?','iloczynwektorowy'],['abyznaleźćwypukłąotoczkę,trzebaumieć:','używaćiloczynuwektorowegolubwinnysposóbobliczać,jakiskręttworzątrzypunkty'],]
        break;
    case "Razem można więcej – podstawy pracy zespołowej"://5/5
    arr=[['etapprojektowaniasystemówpoprzedzaetap:','analizy'],['którezdaniejestprawdziwe?','tworzeniesystemówinformatycznychrozpoczynasięodetapuanalizy'],['językmodelowaniaumlsłużydo:','doprezentowaniawynikówanalizy'],['diagramprzypadkówużyciaumlsłużydoopisania:','funkcji,którebędąwykorzystywaćużytkownicysystemu'],['dowspomaganiaprocesutworzeniasystemówinformatycznychwykorzystujesię:','narzędziatypucase'],]
        break;
    case "Różnorodne algorytmy i ich komputerowe realizacje"://10/10
    arr=[['jakajestreprezentacjaliczby2009wsystemieopodstawie8?','3731'],['maszobliczyćwartośćx15imożeszwykonywaćmnożenieorazdzieleniejakajestnajmniejszaliczbamnożeńlubdzieleńpotrzebnychdoobliczeniawartościtejpotegi?','5'],['dlaktórejparyliczb,15jestnajwiększymwspólnymdzielnikiem?','105,135'],['ilenależywykonaćpojedynczychprzenoszeńkrązkówwłamigłowcewieżhanoidlapięciukrążków?','31'],['któryzapisponiżejjestpoprawnymschematemhorneradlawielomianu:x5-x3-x2+1','((((x)x-1)x-1)x)x+1'],['wkasiezpolskimimonetamibrakłomonetonominałach10gr.i5gr.jakajestnajmniejszaliczbapolskichmonetwtymprzypadku,potrzebnychdoutworzeniareszty63gr.?','5'],['wkasiezpolskimimonetamibrakłomonetonominałach10gr.i5gr.zilupolskichmonetwtymprzypadkuzostanieutworzonareszta63gr.zapomocąalgorytmuzachłannego?','8'],['którezponiższychwyrażeńniedajepoprawnejwartościpotęgix27?','(((x2)2)2)2+((x2)2)2x3'],['filmywmultikiniesąwyświetlanewnastępującychgodzinach:8-11,10-13,12-14,11-14,13-16,15-17,14-17,14-16,16-20,17-19,19-22,20-23ilenajwięcejfilmówwtymmultikiniemożeszobejrzećjednegodnia?','5'],['jakisystemliczbowyniejeststosowanywkomputerach?','kopowy'],['dysponujeszdwomaczerpakamidowodyopojemnościach12i20litrów.możeszużywaćichdonalewaniawodydodużegopojemnikalubdowylewaniawodyztegopojemnika,alezawszeteczerpakimusząbyćpełne.zaczynasztymidwomaczerpakamiwypełniaćpustypojemnik,wlewającdoniegolubwylewając.zniegowodę.którejobjętościwodywpojemnikuniemożeszuzyskaćtąmetodą?','30'],['jakąreprezentacjębinarnąmasumadwóchliczbbinarnych:111111+111111','1111110'],['schemathornerasłużydo:','szybkiegoobliczaniawartościwielomianu'],['jakąmawartośćdziesiątaliczbafibonacciego?','55'],['jakąwartośćdziesiętnąmaliczbabinarnazłożonazsześciujedynek?','26-1'],['jakajestnajmniejszaliczbapolskichmonet,tworzącychresztę97gr.?','5'],]
        break;
    case "Strukturalnie czy obiektowo – czyli droga do sukcesu"://9/10 dziwny błąd wszystk osię zgadza a nie zaznacza
        console.log("zaznacz ręcznie: class Nowa : Stara");
    arr=[['którezpodanychzdańjestprawdziwe?','klasamusiposiadaćmetodękonstruktora'],['istotąhermetyzacjijest?','zapewnienie,żebydostępdopólklasymiałytylkojejmetody'],['którezpodanychzadańjestfałszywe?','wprogramieobiektowymmożemydeklarowaćzmienneifunkcjeglobalne(niezwiązanezżadnaklasą).'],['metodakonstruktoramusibyćoznaczonamodyfikatoremdostępu','public'],['którezpodanychzdańjestfałszywe:','napodstawiedeklaracjiklasymożnautworzyćnajwyżejjedenobiekt'],['wprocesiedziedziczenianiesąprzekazywaneelementyklasyoznaczonemodyfikatorem','private'],['którezpodanychzadańjestprawdziwe?','metodaoznaczonamodyfikatoremdostępuprotectedniemożebyćwywołanaprzezobiektyzewnętrzne'],['wskażpoprawnepolecenietworzeniaobiektunapodstawieklasyonazwienowa?','nowazm=newnowa()'],['wskażpoprawnadeklaracjeklasyonazwienowa,\któradziedziczypoklasieonazwiestara?','classnowa:stara{}'],['cosprawdzapodanewyrażenielogiczneif(tmpisnowa)','czyzmiennatmpreprezentujeobiektklasynowa'],] 
        break;
    case "Struktury danych i ich zastosowanie":
    arr=[['którezdaniasąprawdziwe?(zaznacz2odpowiedzi)','element,któryjakopierwszyprzyjdziedokolejki,opuścijąjakopierwszy'],['mamydanezmienneaibbędącemaskamipewnychzbiorów.zaznaczzdaniaprawdziwe:(zaznacz2odpowiedzi)','spośródelementówstosujakopierwszyopuścigoten,któryprzyszedłnajpóźniej'],['ilewęzłów(włączniezkorzeniem)madrzewotriereprezentującezbiórsłów{"abc","abcd","bcd","bac"}?','a&(~b)toróżnicazbiorówaib'],['ilewspólnychwęzłówmająścieżkiodliścireprezentującychkońceprzedziału[1,3]dokorzeniawdrzewiereprezentującymprzedział[0,7]?','(a|b)^btoróżnicazbiorówaib'],['którestwierdzeniasąprawdziwedladrzewaprzedziałowegotypu(+,max)?(zaznacz2odpowiedzi)','10'],['podzbioryzbioru{a,b,c,d}zapisujemyjakomaskibitowe,przyczymkolejnebityodpowiadająkolejnymliterkom(najniższybitodpowiadalitercea,anajwyższy-d).jakamaskaodpowiadapodzbiorowi{a,c,d}?','2'],['złożonośćalgorytmudijkstryzzastosowaniemkopcabinarnegowynosi(wskażnajlepszeoszacowanie):','operacjainsert(a,b,v)dodaobciążenievdopunktub'],['wprzestrzeniznajdujesięnpunktów.wybieramypłaszczyznę,któradzielizbiórpunktównadwieczęści.ileróżnychpodziałówmożemyconajwyżejuzyskać?podajwynikzdokładnościądorzęduwielkości.','jeślinapustymdrzewiewykonamyinsert(5,5,1)anastępnieinsert(6,6,-1)tooperacjaquery(4,6)zwróciliczbę1'],['rozważmydrzewotriereprezentującezbiórsłów{"acd","bac"}wrazzobliczonymipolamisuf_linkidict_link.którezdaniasąprawdziwe?(zaznacz3odpowiedzi)','13'],['metoda"meetinthemiddle":(zaznacz2odpowiedzi)','o(eloge)'],['jakąwartośćzwracaatan2(1,0)?','n^3'],['którezponiższychstrukturdanychnadająsiędoefektywnejimplementacjiprzeszukiwaniametodąbfs?(zaznacz3odpowiedzi)','suf_linkwęzła"bac"towęzeł"ac"'],['wkopcu,którysłużydoznajdowaniaminimum,przykopcowaniuelementuwdół,aktualnieprzetwarzanyelementzamieniasięewentualniez:','suf_linkwęzła"acd"tokorzeń'],['dopustegodrzewabstwrzucamykolejnowartości:2,4,3,1,5,6.(zaznacz2odpowiedzi)','dict_linkwęzła"acd"tokorzeń'],['wysokośćdrzewabst:(zaznacz2odpowiedzi)','możebyćszybszaniżsprawdzaniewszystkichmożliwości'],['przypomnijmyrozwiązanieproblemuzliczaniaprzecięcodcinkówpoziomychzpionowymi.miotłaprzesuwasięzlewejwprawąiużywadrzewapotęgowego.dlakażdejwspółrzędnejpamiętaileodcinkówpoziomychsiępodniąznajduje.gdynapotykamypoziomyodcinek,dodajemygodomiotły,gdyodcinekpoziomysiękończy,jestonusuwany,wprzypadkugdypodmiotłąznajdziesięodcinekpionowy,zliczamyprzecięciazodcinkamiwmiotle.wprzypadku,gdynadanejwspółrzędnejxznajdujesięwielezdarzeń,najpierwdodajemynoweodcinki,następniezliczamyprzecięcia,poczymusuwamykończącesięodcinkipoziome.gdybyśmynajpierwrozpatrzylizdarzeniarozpoczynaniaikończeniasięodcinkówpoziomych,anastępniezliczaliprzecięciazodcinkamipionowymi,towynik:(zaznacz2odpowiedzi)','poleganarozwiązaniumniejszychpodproblemówiscaleniuwyniku'],['którezsytuacjimogąmiećmiejscewdrzewiebst?(zaznacz3odpowiedzi)','pi/2'],['danyjestgrafo5-ciuwierzchołkachikrawędziachmiędzynimi(początek,koniec,długość):(1,2,2),(2,3,3),(3,4,4),(5,4,1),(5,1,3),(2,5,3),(5,3,1).jakajestwagaminimalnegodrzewarozpinającego?','listadwukierunkowa'],['danyjestteksttodługościnorazkwzorcówdługościconajmniej1,którychłącznadługośćtom.wzorcesąparamiróżne.zakładamy,żerozmiaralfabetujeststały.wskażpoprawnegórneograniczenianaczasdziałaniaalgorytmuaho-corasicka.(zaznacz2odpowiedzi)','kolejka'],['jakajestzłożonośćalgorytmukruskala,przysortowaniukrawędziwczasieo(eloge)isprawdzaniu,czydwawierzchołkinależądotejsamejspójnejzapomocąmetodyprzeszukiwaniadfs,wywoływanejdlakażdejkrawędzi(wskażnajlepszeoszacowanie)?','listajednokierunkowa'],['rozważmypopularnerozwiązanieproblemufind-union(reprezentacjizbiorówrozłącznych)przezpamiętaniedrzewadlakażdegozbioru.stosujemykompresjęścieżekorazkorzystamyzgłębokościdrzewapamiętanejwkażdymkorzeniu.jakajestmaksymalnawysokośćdrzewa?(zaznacz2odpowiedzi)','jegosynemomniejszejwartości'],['danyjestzbiórpłaskichtalerzy.poumyciuczystetalerzedokładanesąnagórę.jeślipotrzebatalerzydoposiłku,topobierasięjezgóry.zapomocąktórejzponiższychstrukturdanychnajlepiejreprezentowaćzbiórtalerzy?','wierzchołekokluczu4madwóchsynów'],['naileminimalnieprzedziałówbazowychmożnarozłożyćprzedział[1,7]?','wierzchołekokluczu3jestsynemtegookluczu4'],]
        break;
